    ...
    <>
        ...
        <div className="max-w-[980px] mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <div>
              ...
              >
                At Adama Soaps, we pride ourselves on creating natural,
                eco-friendly soaps from used coffee grounds. Our focus is on
                simplicity, honesty, and sustainability, aiming to reduce waste
                while delivering high-quality products that nurture your skin.
              </p>
              <h3
                className="font-heading font-normal mb-4"
                style={{
              ...
              >
                We strive to promote sustainability through our handcrafted
                soaps and engage consumers about the benefits of coffee grounds
                as an ingredient.
              </p>
              <h3
                className="font-heading font-normal mb-4"
              ...
              >
                Our commitment to the environment guides every step of our
                process, from sourcing materials to packaging, ensuring that
                your choice of soap is one that supports a healthy planet.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-[980px] mx-auto px-6 lg:px-8">
          ...
          >
            We turn their coffee waste into soaps — you'll find Adama available
            in these cafés.
          </h2>
